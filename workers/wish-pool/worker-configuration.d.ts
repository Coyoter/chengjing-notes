/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cc8058c5e0f4dcbc29ce2d9208109c46)
...
interface __BaseEnv_Env {
	...
	WISH_SIGNING_SECRET: string;
	WISH_SHARD: DurableObjectNamespace<import("./src/index").WishShard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WishShard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WISH_ADMIN_PASSWORD" | "WISH_SIGNING_SECRET">> {}
}
