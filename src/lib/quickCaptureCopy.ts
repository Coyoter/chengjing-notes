...
const copies = {
  "zh-TW": {
    eyebrow: "隨手留下來", title: "隻言片語", placeholder: "此刻腦中閃過什麼？", submit: "留下來", saved: "已儲存為未整理卡片", enterHint: "Enter 儲存 · ⌥ Enter 換行 · Esc 關閉",
  ...
  "zh-CN": {
    eyebrow: "随手记下来", title: "只言片语", placeholder: "此刻脑中闪过什么？", submit: "留下来", saved: "已保存为未整理卡片", enterHint: "Enter 保存 · Alt+Enter 换行 · Esc 关闭",
  ...
  en: {
    eyebrow: "Capture in the moment", title: "Fragment", placeholder: "What just crossed your mind?", submit: "Keep it", saved: "Saved as an unfiled card", enterHint: "Enter to save · Option+Enter for a new line · Esc to close",
  ...
  ja: {
    eyebrow: "思いついた瞬間に", title: "ひとこと", placeholder: "今、頭をよぎったことは？", submit: "残す", saved: "未整理カードとして保存しました", enterHint: "Enterで保存 · ⌥ Enterで改行 · Escで閉じる",
  ...
  ko: {
    eyebrow: "떠오른 순간에", title: "짧은 생각", placeholder: "지금 머리를 스친 것은 무엇인가요?", submit: "남기기", saved: "미분류 카드로 저장했습니다", enterHint: "Enter로 저장 · ⌥ Enter로 줄바꿈 · Esc로 닫기",
