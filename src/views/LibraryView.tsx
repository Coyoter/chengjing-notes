...
export function LibraryView() {
  ...
  return <div className="library-layout">
    ...
    <div className="page-scroll standard-page library-content">
      ...
      <div className="collection-tabs" aria-label={t("library.categories")}><button type="button" className={collection === "library" ? "is-active" : ""} onClick={() => setCollection("library")}><FileStack size={15} />{t("nav.library")}</button><button type="button" className={collection === "archive" ? "is-active" : ""} onClick={() => setCollection("archive")}><Archive size={15} />{t("library.archive")}</button><button type="button" className={collection === "trash" ? "is-active" : ""} onClick={() => setCollection("trash")}><Trash2 size={15} />{t("library.trash")}</button>{collection === "trash" && <EmptyTrashButton/>}</div>
